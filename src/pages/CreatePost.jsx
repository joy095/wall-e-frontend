    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create imaginative and visually stunnin ithrough DALL-E AI and share
          them with the coummnity
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          >
            {loading ? "Sharing..." : "Share with th comunity"}
          </button>
        </div>
      </form>
    </section>
